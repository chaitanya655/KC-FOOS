  ...
  return (
    <div className="flex items-start justify-between py-4 border-b border-gray-700 last:border-b-0">
      <div className="flex-grow pr-4">
        ...
        <h4 className="font-semibold text-gray-100">{dish.name}</h4>
        <div className="font-semibold text-gray-200 my-1">₹{dish.price}</div>
      ...
      <div className="flex-shrink-0 text-center relative">
        ...
        <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-[90px]">
          {quantity > 0 ? (
            <div className="flex items-center justify-between bg-gray-700 text-primary font-bold shadow-lg rounded-md border border-gray-600 text-lg">
              <button 
                onClick={onDecrease} 
            ...
            <button 
              onClick={onIncrease}
              className="bg-gray-700 text-primary font-bold py-1 px-6 shadow-lg rounded-md border border-gray-600 hover:bg-primary hover:text-white transition-colors"
